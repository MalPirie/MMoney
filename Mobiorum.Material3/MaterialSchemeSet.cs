...
public sealed class MaterialSchemeSet
{
    ...
    private static MaterialSchemeSet Orange { get; } = new()
    {
        Light = new MaterialScheme
        {
            ...
            InverseSurface = Color.FromArgb("#362F2A"),
            InverseOnSurface = Color.FromArgb("#FBEEE4"),
            InversePrimary = Color.FromArgb("#FFB77C"),
        ...
        Dark = new MaterialScheme
        {
            ...
            InverseSurface = Color.FromArgb("#EFE0D5"),
            InverseOnSurface = Color.FromArgb("#322B26"),
            InversePrimary = Color.FromArgb("#B35A00"),
